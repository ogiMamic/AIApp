...
const KnowledgePage = () => {
  ...
  const { selected, updateKnowledge } = useKnowledgesStore();
                ...
                <div className="mt-4 flex-col lg:col-span-6">
                  <div className="flex-col ">
                    ...
                    <Input
                      ...
                      className="mt-1 w-full"
                      placeholder="Füge eine kurze Beschreibung hinzu, was dieser Knowledge macht."
                      // Stellen Sie sicher, dass Sie value und onChange hinzufügen, um den State zu verwalten
                      // value={knowledgeInfo.description}
                      // onChange={handleKnowledgeInfoChange}
                    />
                  ...
                  <div className="mt-4 flex-col ">
                    ...
                    <Textarea
                      id="knowledgeAnweisungen"
                      name="anweisungen"
                      value={anweisungen}
                      onChange={(e) => setAnweisungen(e.target.value)}
                      className="mt-1 w-full h-25 "
                      placeholder="Was macht dieser Customer Knowledge? Wie verhält er sich? Was sollte er vermeiden zu tun?"
                      // Stellen Sie sicher, dass Sie value und onChange hinzufügen, um den State zu verwalten
                      // value={knowledgeInfo.description}
                      // onChange={handleKnowledgeInfoChange}
                    />
                    ...
                    <Input
                      ...
                      name="description"
                      className="mt-1 w-full"
                      placeholder="Welche Fragen würdest du dem Benutzer vorschlagen, an den Knowledge zu stellen?"
                      // Stellen Sie sicher, dass Sie value und onChange hinzufügen, um den State zu verwalten
                      // value={knowledgeInfo.description}
                      // onChange={handleKnowledgeInfoChange}
                    /> */}
